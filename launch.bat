...
REM   Docker Desktop -> hr-postgres -> Ollama -> Python sidecars (SMTP/IMAP/recording) -> n8n -> React frontend
REM Then opens http://localhost:3001 in your default browser.
